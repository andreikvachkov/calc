...
class mywindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_mix.clicked.connect(self.negate)
    ...
    def add_digit(self):
        ...
        btn = self.sender() # Ввозвращает сигнал с нажатой кнопки

        digit_buttons = ('btn_0', 'btn_1', 'btn_2', 'btn_3', 'btn_4',
                            'btn_5', 'btn_6', 'btn_7', 'btn_8', 'btn_9') # Кортеж с именами кнопок
    ...
    def remove_error(self):
        if self.ui.le_entry.text() in (error_undefined, error_zero_div):
            self.ui.le_entry.setMaxLength(self.ui.le_entry.maxLength())
            self.ui.le_entry.setText('0')
            self.adjust_entry_font_size()
    ...
    def disable_buttons(self, disable: bool) -> None:
        ...
        self.ui.btn_mix.setDisabled(disable)
    ...
    def change_buttons_color(self, css_color: str) -> None:
        ...
        self.ui.btn_mix.setStyleSheet(css_color)
